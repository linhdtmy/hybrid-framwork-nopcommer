...
public class Test_10_Assert_Verify extends BaseTest {
	...
	public void TC_01_Register() {
		...
		verifyEquals(registerPageObject.getRegisterSuccessMessage(), "Your registration completed123");
	...
	public void TC_02_Login_Success() {
		...
		homePageObject = GenerateObject.getHomePage(driver);
		verifyFalse(homePageObject.isDisplayMyAccount());
	}
	...
	public void TC_03_Customer_Infor() {
		...
		verifyFalse(customerInformObject.isMyAccountIsDisplay());
